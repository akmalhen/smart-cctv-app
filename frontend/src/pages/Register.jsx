// src/pages/Register.jsx (Alignment Sempurna)
...
const Register = () => {
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      {/* Panel Kiri (Form) */}
      {/* DIUBAH: Padding global (p-*) dihapus, diganti dengan padding horizontal (px-*) */}
      <div className="w-full md:w-1/4 bg-primary text-white px-8 md:px-12 flex flex-col">
        
        {/* Bagian Atas Form */}
        {/* DIUBAH: Ditambahkan padding-top (pt-*) */}
        <div className="pt-8 md:pt-12">
          <Link to="/">
            <img src={Logo} alt="SmartCCTV Logo" className="h-8 mb-16 brightness-0 invert" />
          </Link>
          <h2 className="font-alice text-3xl mb-8">Create your account</h2>
          <form className="space-y-6">
            <div>
              <label htmlFor="username" className="block text-sm font-medium mb-2">Username</label>
              <input type="text" id="username" className="w-full bg-primary border-2 border-gray-400 rounded-2xl p-3 focus:outline-none focus:border-white transition-colors" />
            </div>
            <div>
          ...
          <div className="flex items-center my-8">
            ...
            <span className="mx-4 text-gray-300 text-sm">or sign-in with google</span>
            <div className="flex-grow h-px bg-gray-400"></div>
          </div>
        ...
        {/* DIUBAH: Dihapus pt-8, diganti dengan padding-bottom (pb-*) */}
        <div className="mt-auto flex justify-between items-center pb-8 md:pb-12">
          <p className="text-sm">
            have an account? <Link to="/login" className="font-bold hover:underline">log-in</Link>
          </p>
